  ...
  describe '#verify!' do
    ...
    context 'when attestation exists' do
      ...
      it do
        expect do
          subject
        end.to raise_error WebAuthn::NotImplementedError, 'Unsupported Attestation Format: android-safetynet'
      end

      context 'when ignore_attestation given' do
        subject { context_instance.verify! attestation_object, ignore_attestation: true }
